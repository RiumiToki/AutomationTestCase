...
await page.getByRole('row', { name: 'access_kanwil_I Action Access' }).getByRole('link').first().click();
await page.getByRole('textbox', { name: 'Nama' }).fill('Access kanwil II');
await page.getByRole('textbox', { name: 'Deskripsi' }).fill('Access kanwil II');
