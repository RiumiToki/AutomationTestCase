...
await page.getByRole('button', { name: ' Unduh Kartu Kehadiran' }).click();
await page.getByLabel('Unduh Kartu Kehadiran').getByLabel('', { exact: true }).click();
await page.getByLabel('Unduh Kartu Kehadiran').locator('b').click();
await expect(page.getByLabel('Unduh Kartu Kehadiran').getByLabel('', { exact: true })).toBeVisible();
});